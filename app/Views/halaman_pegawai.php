  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0">
      ...
      <div class="navbar-brand col-md-3 bg-white col-lg-7 me-0 justify-content-between">
        <div class="d-block">
          <h2>Selamat pagi, Mayang <img src="<?=base_url('/public/Assets/img/icon-hai.png');?>" alt="" class="icon-hai">  </h2>
    ...
    <main class="container-fluid">
      <div class="row justify-content-center">
            ...
            <ul class="nav flex-column ps-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <i class="iconsax" icon-name="document-copy"></i>Proyek
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <i class="iconsax" icon-name="calendar-day"></i>Kalendar
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <i class="iconsax" icon-name="group"></i>Tim Kerja
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
        ...
        <div class="main-content col-md-6 col-lg-7">
          ...
          <div class="mb-4">
            <h3 class="title">Progress Task</h3>
            <div class="row">
              <div class="col-lg-4">
              ...
              <div class="col-lg-12">
                <div class="card today-task">
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <div class="num">1.</div>
                      <h1>[In Progress] Landing Page Dosen : Styling Card Dashboard</h1>
                    </div>
                    <div class="badge">
                      Estimasi 2 jam
                    </div>
              ...
              <div class="col-lg-12">
                 <div class="card today-task">
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <div class="num">2.</div>
                      <h1>[In Progress] Landing Page Dosen : Styling Sidebar Dashboard</h1>
                    </div>
                    <div class="badge">
                      Estimasi 4 jam
                    </div>
              ...
              <div class="col-lg-12">
                 <div class="card today-task">
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <div class="num">3.</div>
                      <h1>[In Progress] Landing Page Dosen : Styling Header Dashboard</h1>
                    </div>
                    <div class="badge">
                      Estimasi 2 jam
                    </div>
